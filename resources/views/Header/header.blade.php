...
<!--   <title>SB Admin 2 - Dashboard</title> -->
  <title>@yield('page_title','Task')</title>
    ...
    <ul class="navbar-nav bg-gradient-primary sidebar sidebar-dark accordion" id="accordionSidebar">
      ...
      <li>
        {{--  <a class="dropdown-item" href="{{ route('logout') }}"
                                      ...
                                      <i class="fas fa-fw fa-tachometer-alt"></i>    <span style="color:white"> {{ __('Logout') }}</span>
                                    </a>
      ...
      <li class="nav-item">
        ...
        <div id="collapseTwo" class="collapse" aria-labelledby="headingTwo" data-parent="#accordionSidebar">
          <div class="bg-white py-2 collapse-inner rounded">
            <h6 class="collapse-header">POST List:</h6>

            <a class="collapse-item {{Request::routeIs('Blog.index')? 'active' : '' }}" href="{{route('Blog.index')}}">Blog List</a>
            <a class="collapse-item {{Request::routeIs('Blog.create')? 'active' : '' }}" href="{{route('Blog.create')}}">Add POST</a>
             {{-- <a class="collapse-item {{Request::routeIs('front_validation')? 'active' : '' }}" href="{{route('front_validation')}}">Add POST</a> --}}
            ...
            <li class="nav-item dropdown no-arrow mx-1">
              {{-- <a class="nav-link dropdown-toggle" href="#" id="alertsDropdown" role="button" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
               ...
               <a class="nav-link dropdown-toggle" href="{{ route('logout') }}"
                                      ...
                                      <i class="fas fa-sign-out-alt fa-sm fa-fw "></i>    <span style="color:Black"> {{ __('Logout') }}</span>
                                    </a>
